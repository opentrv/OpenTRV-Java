 ...
 * and the data files are read from particular names within that input directory.
 * <p>
 * An output directory is supplied
 * and the output files will be written to specific files within that output directory.
 */
